...
import {
  ...
  type HourlyCheckGateConfig,
} from "./hourly-check-gate.js";

const baseSignals: HourlyCheckSignals = {
  pendingObsCount: 0,
  maxNoveltyScore: 0,
...
const baseConfig: HourlyCheckGateConfig = {
  heartbeatHours: 4,
  stage2Enabled: false,
};

function withSignals(patch: Partial<HourlyCheckSignals>): HourlyCheckSignals {
